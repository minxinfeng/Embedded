...
How to get the road?
    ...
    4.Get the shorted path node id by floyd algorithm£¬ all the ids store in: list<int> ids;
    5.Get the detail info of the nodes and return the list<posNode> pathNodes